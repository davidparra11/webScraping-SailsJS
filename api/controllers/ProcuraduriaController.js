...
module.exports = {
	...
	boletinesNuevos: function(req, res) {
		...
		//variable de entorno: selecciona el numero de resultados del paginador de la procuraduria para cada año.
...
/*
  Descripción: Extrae los valores de los boletínes antes del 2011 requeridos por la base de datos
  err: Mensaje de error retornado por el request
  resp: Código respuesta del request
  body: Contenido de la respuesta del request
  dirInterna : la direccion con la cual se va a crear el archivo html.
 */
